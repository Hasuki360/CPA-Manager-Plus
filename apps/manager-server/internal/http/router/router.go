...
func New(appCtx *app.Context) http.Handler {
	...
	mux.HandleFunc("/", rootHandler(appCtx, usageHandler, modelPriceHandler, apiKeyAliasHandler, accountActionHandler, dashboardHandler, monitoringHandler, proxyHandler))
